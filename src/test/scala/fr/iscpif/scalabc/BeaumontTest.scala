...
import fr.iscpif.scalabc.algorithm.{ Beaumont, WeightedSimulation, Simulation }
...
class BeaumontTest extends FunSuite {
  ...
  test("computeWeights") {
    val previouslyAccepted = List(
      WeightedSimulation(Simulation(List(1.5601863631356871, 1.5599452108107381), List(3.8476952539792935, 3.1170287169055837), 3.035276029115123), 0.10000000000000002),
      WeightedSimulation(Simulation(List(1.8182496714907215, 1.834045144540295), List(4.379858496063885, 4.01797545331939), 1.6021660506167255), 0.10000000000000002),
      WeightedSimulation(Simulation(List(5.924145648891164, 0.46450419127052944), List(7.116213520194562, 3.4350139553668613), 3.681199564827701), 0.10000000000000002),
      WeightedSimulation(Simulation(List(3.0461376929232853, 0.9767210827609629), List(4.750422455717117, 3.6584503774308583), 1.5911271668520248), 0.10000000000000002),
      WeightedSimulation(Simulation(List(1.22038239389608, 4.951769088684754), List(6.8997151626137025, 6.726275286229557), 3.6259904488432593), 0.10000000000000002),
      WeightedSimulation(Simulation(List(0.8849250630205829, 1.9598286629966277), List(3.572317406050079, 2.417524974871681), 4.010157619078241), 0.10000000000000002),
      WeightedSimulation(Simulation(List(0.4522728862124703, 3.2533032960495123), List(4.43313986229485, 2.154604343188701), 3.4122557945164487), 0.10000000000000002),
      WeightedSimulation(Simulation(List(3.584657259445938, 1.1586905889152987), List(5.470911528394105, 4.83673210276676), 0.6341794256273454), 0.10000000000000002),
      WeightedSimulation(Simulation(List(3.308980181129293, 0.6355834559825424), List(4.672127317144703, 2.7863565310597402), 2.5415161517955567), 0.10000000000000002),
      WeightedSimulation(Simulation(List(0.31429184910112484, 6.364104073549839), List(7.405959602683832, 2.6834095089078254), 4.7225500937760065), 0.10000000000000002)
    )
